...
public class CommandLineAppStartupRunner implements CommandLineRunner {
		...
		public CommandLineAppStartupRunner(CooperativeService coopService, ProductService prodService, CooperativeProductService coopProdService, AnualResultService anualResultService, CategoryService categoryService, UserService userService) {
		...
		public void run(String... args) throws Exception {
				...
				if (!dbAlreadyStarted) {
						...
						UserEntity userEntity2 = UserEntity.builder().document("0101-01").password(new MD5Crypt().encode("senha")).role("coop").codCoop(coop1).name("Manager 0101").build();
